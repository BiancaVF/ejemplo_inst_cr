...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-67.879363, -46.069405, -67.126644, -45.684149], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [-67.777252, -45.999890, 0.000000, 0.000000],
            units: 'degrees'})
    })
});
...
map.getView().fit([-67.879363, -46.069405, -67.126644, -45.684149], map.getSize());
